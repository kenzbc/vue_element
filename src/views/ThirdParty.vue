<template>
    <div class="third-party-list">
        <el-form :inline="true" :model="formInline">
            <el-form-item>
                <el-input placeholder="运营商" v-model="queryParams.name" type="" style="width:150px;"></el-input>
            </el-form-item>

            <el-form-item  style="float:right;margin-right: 0">
                <router-link to="/third-party/create">
        ...
        <el-table :data="tableData" border stripe  v-loading="loading">
            <el-table-column prop="id" label="APPid" align="center" width="100"></el-table-column>
            <el-table-column prop="add_time" label="创建时间" align="center"></el-table-column>
            <el-table-column prop="name" label="渠道商" align="center"></el-table-column>
            <el-table-column prop="appkey" label="appkey" align="center" width=""></el-table-column>

            <el-table-column label="操作" class="center" align="center" width="240">
                <template scope="scope">
                    <router-link :to="{ path:'/third-party/' + scope.row.id }" tag="el-button" class="el-button--small el-button--primary">修改</router-link>
    ...
    export default {
        ...
        methods: {
            ...
            requestList (data) {
                const _this = this
                _this.loading = true
                this.ajax('member/third_party_list.php', this.tableQueryParams, function (response) {
                    _this.loading = false
                ...
                switch (type) {
                    case 'del':
                        this.$confirm('确定删除吗？', '提示', {
                            ...
                            _this.ajax('member/third_party_op.php', {id: row.id,act:'del'}, function (response) {
