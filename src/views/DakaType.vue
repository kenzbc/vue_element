<template>
    <div class="daka-type-list">
        <el-form :inline="true">
            <el-form-item  style="float:right;margin-right: 0">
                <router-link to="/daka-type/create">
                    <el-button type="default" icon="plus">新增类型</el-button>
                </router-link>
            </el-form-item>
        </el-form>
        ...
        <el-table :data="tableData" border stripe  v-loading="loading">
            ...
            <el-table-column prop="name" label="选手卡类型名称" align="center"></el-table-column>

            <el-table-column label="操作" class="center" align="center" width="240">
                <template scope="scope">
                    <router-link :to="{ path:'/daka-type/' + scope.row.id }" tag="el-button" class="el-button--small el-button--primary">修改</router-link>
    ...
    export default {
        ...
        methods: {
            ...
            requestList (data) {
                const _this = this
                _this.loading = true
                this.ajax('match/daka_type_list.php', this.tableQueryParams, function (response) {
                    _this.loading = false
                ...
                switch (type) {
                    case 'del':
                        this.$confirm('确定删除吗？', '提示', {
                            ...
                            _this.ajax('match/daka_type_op.php', {id: row.id,act:'del'}, function (response) {
