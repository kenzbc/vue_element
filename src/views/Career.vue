    ...
    <div class="portfolio-list">
        <el-form :inline="true" :model="queryParams">
            <el-form-item  style="float:right;margin-right: 0">
                <router-link :to="{ path:'/career/create', query: { playerID:  this.$route.query.playerID} }">
        ...
        <el-table :data="tableData" border stripe  v-loading="loading">
            ...
            <el-table-column prop="team_name" label="服役战队" align="center" width=""></el-table-column>
            ...
            <el-table-column label="操作" class="center" align="center" width="240">
                <template scope="scope">
                    <router-link :to="{ path:'/career/'+ scope.row.id, query: { playerID:  $route.query.playerID} }" tag="el-button" class="el-button--small el-button--primary">编辑</router-link>
